...
class Submarine(MovableNewtonObject):
    ...
    MAX_ACCELERATION = 2.0 * 3600  # acceleration in knots/hour^2 -> imax acceleration 2 Knots / second^2
    ...
    target_speed = property(get_target_speed, set_target_speed, None, "Speed")
